...
<div class="col-sm-6 col-md-3 grid-margin">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <p style="font-family: cursive; font-size:30px; font-weight: bold; text-align: center;">{{$value}}</p>
                            </div>
                          </div>
                        </div>
<div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <p style="font-family: cursive; font-size:30px; font-weight: bold; text-align: center;">8000</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title">Exam Taken</h2>
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title">Mark provided</h2>
                  <p style="font-family: cursive; font-size:30px; font-weight: bold; text-align: center;">1</p>
                </div>
              </div>
            </div>
